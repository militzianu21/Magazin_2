...
Public Class Form_verif_gestiune
    ...
    Private Sub Form_verif_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If dbread.HasRows Then
                TextBox1.Text = (dbread("gestiune_sold_final").ToString)
            End If
        ...
        Try
            ...
            If dbread2.HasRows Then
                If dbread2("permanent") = True Then
                    ...
                    If TextBox1.Text = "0" Then
                        TextBox1.Text = (dbread2("gestiune_sold_initial").ToString)
                    End If
            ...
            End If
        Catch ex As Exception
            MsgBox("Problem loading data gestiune: " & ex.Message.ToString)
            'dbread2.Close()
        End Try
        dbread2.Close()
        dbconn.Close()
