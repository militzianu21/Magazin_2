...
Public Class Form_adauga_nir
    ...
    Private Sub Form_adauga_nir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        tbn.Rows.Add("1. Marfa", "Mf")
        tbn.Rows.Add("2. Mijloace Fixe", "Fx")
        tbn.Rows.Add("3. Transfer", "Tr")
        ...
        Dim sql_read As String = "SELECT nir,data,magazin FROM niruri ORDER BY data DESC, nir DESC LIMIT 1"
        Try
            If dbconn.State = ConnectionState.Closed Then
                dbconn.Open()
            End If
    ...
    Private Sub ad_prod_But_Click(sender As Object, e As EventArgs) Handles ad_prod_But.Click
        ...
        If bun = True Then
            If edit_mode = False Then
                ...
                DataGridView1.Rows(row).Cells("pr_ach_tva").Value = FormatNumber(CDec(pret_ach_tva_TB_1.Text), 2)
    ...
    Private Sub Save_Bu_Click(sender As Object, e As EventArgs) Handles save_Bu.Click
        ...
        If dbconn.State = ConnectionState.Closed Then
            dbconn.Open()
        End If
        If tip_nir_CB.SelectedValue = "Mf" Then
            ...
            For i As Integer = 0 To DataGridView1.Rows.Count - 1
                ...
                Dim sql_marf As String = "INSERT INTO marfa (produs,pret,bucati,nir,data,pret_intrare,magazin) VALUES(@produs,@pret,@bucati,@nir,@data,@pret_intrare,@magazin)"
    ...
    Private Sub textbox_2_Leave(sender As Object, e As EventArgs) Handles cant_TB_1.Leave, pret_ach_TB_1.Leave
        ...
        Else : pret_ach_tva_TB_1.Text = FormatNumber(CDec(pret_ach_TB_1.Text) + (CDec(pret_ach_TB_1.Text) * tva / 100), 2)
        End If
    ...
    Private Sub PrintNir_BU_Click(sender As Object, e As EventArgs) Handles PrintNir_BU.Click
        ...
        ElseIf tip_nir_CB.SelectedValue = "Fx" Then
            fact_avz = "factura fiscala nr. "
    ...
    Private Sub CheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox1.CheckedChanged
        ...
        If CheckBox1.CheckState = CheckState.Checked Then
            upd_int_CHK.CheckState = CheckState.Unchecked
            nir_TB.Text = nir & "MF"
        ElseIf CheckBox1.CheckState = CheckState.Unchecked Then
            upd_int_CHK.CheckState = CheckState.Checked
            nir_TB.Text = nir
        End If
    End Sub
End Class
